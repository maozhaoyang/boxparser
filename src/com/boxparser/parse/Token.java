...
import com.boxparser.html.nodes.Attribute;
import com.boxparser.html.nodes.Attributes;
...
abstract class Token {
    ...
    static class Doctype extends Token {
        ...
        public String toString() {
            ...
            if (publicIdentifier.length() > 0) accum.append(" PUBLIC \"").append(getPublicIdentifier()).append("\"");
            if (systemIdentifier.length() > 0) accum.append(" \"").append(getSystemIdentifier()).append("\"");
            accum.append('>');
    ...
    static abstract class Tag extends Token {
        ...
        private int  pendingAttributeChar = 0;
        ...
        void newAttribute() {
            if (pendingAttributeName != null) {
                ...
                Attribute attribute = new Attribute(pendingAttributeName, pendingAttributeValue, (char)pendingAttributeChar);
                attributes.put(attribute);
            }
            pendingAttributeName = null;
            pendingAttributeValue = null;
            pendingAttributeChar = 0;
        }
        ...
        void setBeforeAttributeChar(char pendingAttributeChar){
            this.pendingAttributeChar = pendingAttributeChar;
        }
