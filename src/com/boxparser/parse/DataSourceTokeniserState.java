...
enum DataSourceTokeniserState {
    Data {

        // in data state, gather characters until a character reference or tag is found
        void read(DataSourceTokeniser t, CharacterReader r) {
            switch (r.current()) {
                // case '&':
                ...
                case eof:
                    ...
                    break;
                default:
                    String data = r.consumeToAny('<', nullChar); // '&', '<', nullChar
                    t.emit(data);
                    break;
            }
        }
    ...
    RCDATAEndTagName {
            ...
            switch (c) {
                ...
                case '>':
                    if (t.isAppropriateEndTagToken()) {
                        ...
                        // zhaoyang add for "<textaera> <span></span"
                        t.dataBuffer.append(c);
                        anythingElse(t, r);
                    }
                    break;
                default: {
                 // zhaoyang add for "<h3>«¿ªı÷–</h>"
                    t.dataBuffer.append(c);
                    anythingElse(t, r);
                }
            }
        ...
        private void anythingElse(DataSourceTokeniser t, CharacterReader r) {
    ...
    ScriptDataDoubleEscapeStart {
        ...
        void read(DataSourceTokeniser t, CharacterReader r) {
            ...
            switch (c) {
                ...
                case '/':
                case '>':
                    if (t.dataBuffer.toString().equals("script")) t.transition(ScriptDataDoubleEscaped);
                    else t.transition(ScriptDataEscaped);
                    t.emit(c);
                    break;
                default:
                    r.unconsume();
        ...
        void read(DataSourceTokeniser t, CharacterReader r) {
            ...
            switch (c) {
                ...
                case '"':
                    ...
                    t.tagPending.setBeforeAttributeChar(c);
                    break;
                // case '&':
                // r.unconsume();
    ...
    AttributeValue_doubleQuoted {
        ...
        void read(DataSourceTokeniser t, CharacterReader r) {
            String value = r.consumeToAny('"', nullChar, '>');// '"', '&', nullChar
    ...
    abstract void read(DataSourceTokeniser t, CharacterReader r);

    private static final char   nullChar        = '\u0000';
    private static final char   replacementChar = DataSourceTokeniser.replacementChar;
    private static final String replacementStr  = String.valueOf(DataSourceTokeniser.replacementChar);
